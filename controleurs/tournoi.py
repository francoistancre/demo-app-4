...
class TournoiControleur:
    ...
    def create_tournoi(self):
        ...
        tournoi = Tournoi(tournoi['index_tournoi'],
            tournoi['nom_tournoi'], 
    ...
    def rapport_joueurs_tournoi(self, ordre):
        ...
        if ordre == "alphabetique":
            liste_joueurs_tournoi_sorted = sorted(liste_joueurs_tournoi, key=lambda d: d['nom'], reverse=False)
            self.rapport_vue.get_rapport_data(liste_joueurs_tournoi_sorted, "Liste des joueurs du tournoi par ordre alphabétique")
        elif ordre == "classement":
            liste_joueurs_tournoi_sorted = sorted(liste_joueurs_tournoi, key=lambda d: d['classement'], reverse=True)
            self.rapport_vue.get_rapport_data(liste_joueurs_tournoi_sorted, "Liste des joueurs du tournoi par classement")
